    ...
    <>
      <ul className="nav nav-pills py-1 mb-3 mx-2 border rounded text-light bg-light d-flex justify-content-evenly" id="pills-tab" role="tablist">
        ...
        <li className="nav-item ms-1" role="presentation">
          <button className="nav-link link-dark border border border-dark" id="pills-HtmlIndex-tab" data-bs-toggle="pill" data-bs-target="#pills-HtmlIndex" type="button" role="tab" aria-controls="pills-History" aria-selected="false">HTML</button>
        </li>
