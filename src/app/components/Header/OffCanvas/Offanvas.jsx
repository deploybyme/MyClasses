...
export default function Offanvas(props) {
  ...
  return (
    <>
    <div className="offcanvas offcanvas-start sidebar-nav text-light" data-bs-scroll="true" tabIndex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
