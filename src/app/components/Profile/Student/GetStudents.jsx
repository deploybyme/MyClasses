                ...
                <div key={data.id} className="accordion shadow-0 mt-1 overflow-hidden" id={`StudentDetails${index}`}>
                  <div  className="accordion-item ">
                    <h2 className="accordion-header rounded-0">
                      <div className="accordion-button rounded-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target={`#Collapse${index}`} aria-expanded="false" aria-controls="collapseTwo">
