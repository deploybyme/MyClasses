      ...
      <section className="py-2 mt-4 mx-1 rounded text-light bg-dark bg-gradient">
        ...
        <div className="list-group">
          ...
          <div className="list-group-item border-0 rounded-0 text-light bg-dark" style={{ textAlign: "justify" }}>
            ...
            <p>
              The <span className='p-1 border rounded'>struct</span> <span className='text-primary'>keyword</span> defines a structure type followed by an <span className='text-primary'>identifier</span> (name of the structure).
            </p>
            <p>
            ...
            <p>
              Once you declare a structure <span className='p-1 border rounded'>Person</span> as above, you can define a structure variable as:
            </p>
            ...
            <p>
              Here, a structure variable <span className='p-1 border rounded'>data</span> is defined, which is of type structure <span className='p-1 border rounded'>Person</span>.
            </p>
            <p>
            ...
            <p>
              The members of a structure variable are accessed using a <span className="fw-bold">dot ( . )</span> <span className='text-primary'>operator</span>.
            </p>
            <p>
              Suppose you want to access the age of the structure variable <span className='p-1 border rounded'>data</span> and assign <span className="fw-bold">50</span> to it.
              <br />You can perform this task by using the following code:
            </p>

            <p className='bg-black rounded mt-2 p-2' id="CodeBox">
              <code className='text-light'>
                data.age = <span className="text-warning">50</span>;
              </code>
            </p>
            ...
            <p className='bg-black rounded mt-2 p-2' id="CodeBox">
              <code className='text-light'>
                <span className='fw-lighter text-secondary'>// Program to assign data to members of a structure variable</span>
                <br />
